...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-mode-hook '(lambda () (setq-local electric-pair-pairs (append '((electric-pair-pairs) (36 . 36)))))) ;; $$
  (add-hook 'LaTeX-mode-hook '(lambda () (setq-local electric-pair-pairs (append '((electric-pair-pairs) (36 . 36)))))) ;; $$
#+end_src
**** color parenthesis
#+begin_src emacs-lisp
  (show-paren-mode)
