...
#+begin_src emacs-lisp
  ...
  (use-package mixed-pitch
    ...
    :hook ((org-mode TeX-mode) . mixed-pitch-mode)) ;; keep filled cursor
...
#+begin_src emacs-lisp
  ...
  ;; replace the some default bullets / list item styles
  ...
  ;; automatically change bullet on indent / dedent
