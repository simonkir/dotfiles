...
hl.bind("SUPER + 9", hl.dsp.exec_cmd("swaylock"))
hl.bind("SUPER + SHIFT + 9", hl.dsp.exec_cmd("swaylock"))
...
hl.bind("SUPER + ALT + CTRL + B", hl.dsp.exec_cmd("blueberry"))
...
hl.bind("SUPER + ALT + X", hl.dsp.exec_cmd("~/.config/simonkir/random-wallpaper.sh"))
