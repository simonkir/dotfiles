...
# *** swapping
    ...
    EzKey("M-S-<left>", lazy.layout.move_left()),
    EzKey("M-S-<down>", lazy.layout.move_down()),
    EzKey("M-S-<up>", lazy.layout.move_up()),
    EzKey("M-S-<right>", lazy.layout.move_right()),
    ...
    EzKey("M-C-<left>", lazy.layout.integrate_left()),
    EzKey("M-C-<down>", lazy.layout.integrate_down()),
    EzKey("M-C-<up>", lazy.layout.integrate_up()),
    EzKey("M-C-<right>", lazy.layout.integrate_right()),
