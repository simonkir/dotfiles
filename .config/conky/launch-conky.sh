...
if test $screencount = 2
    # screen 1 -- primary
    conky --xinerama-head=0 --config=$HOME/.config/conky/clock.conkyrc --alignment tm -x 125 -y 100 &
    conky --xinerama-head=0 --config=$HOME/.config/conky/worldclock.conkyrc --alignment tm -x -215 -y 100 &
    ...
    conky --xinerama-head=1 --config=$HOME/.config/conky/worldclock.conkyrc --alignment tr -x 80 &
    conky --xinerama-head=1 --config=$HOME/.config/conky/quotes.conkyrc --alignment bl -y 70 -x 50 &

else if test $screencount = 1
    conky --config=$HOME/.config/conky/clock.conkyrc --alignment tm -x 125 -y 85 &
    conky --config=$HOME/.config/conky/worldclock.conkyrc --alignment tm -x -215 -y 85 &
